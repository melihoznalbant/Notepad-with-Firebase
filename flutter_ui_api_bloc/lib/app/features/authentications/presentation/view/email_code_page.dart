          ...
          child: Column(
            ...
            children: [
              ...
              const CustomDescriptionLinkWidget(
                customDescription: "We sent a reset link to ",
                emailLink: "deneme@den...com",
                customDescriptionCont:
              ...
              CustomizeElevatedButton(
                onTap: () => context.router.push(const ResetPassword2Route()),
              ...
              const RecentEmailTextWidget(
                firstMessage: "Haven't got the email yet?",
                secondMessage: "Resend email",
              ),
            ],
          ),
        ),
